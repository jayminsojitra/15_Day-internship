...
$q = mysqli_query($connection, "update tbl_student2 set is_delete =1 where st_id = '{$id}'") or die(mysqli_error($connection));

if ($q) {
  echo "<script>alert('Your data is successfully deleted'); window.location = 'table2.php';</script>";
}